          ...
          >
            <div className="p-6 border-b border-[#1E293B] flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-white">About ExteriorVision</h3>
              </div>
            ...
            <div className="p-6 space-y-4">
              <p className="text-[#94A3B8] text-sm leading-relaxed">
                ExteriorVision is an AI-powered full home exterior visualizer that lets you preview roofing, siding, gutters, and accent colors on your home — before committing to a purchase.
              </p>
              ...
              <p className="text-[#475569] text-[10px] leading-relaxed">
                Color values are best-effort digital approximations — physical samples are the authoritative reference.
              </p>
            </div>
          </motion.div>
        </motion.div>
