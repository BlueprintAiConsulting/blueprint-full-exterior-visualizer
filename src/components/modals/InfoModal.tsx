          ...
          >
            ...
            <div className="p-6 space-y-4">
              <p className="text-[#94A3B8] text-sm leading-relaxed">
                BlueprintEnvision is an AI-powered full home exterior visualizer that lets you preview roofing, siding, gutters, and accent colors on your home — before committing to a purchase.
              </p>
