...
export const ROOFING_OPTIONS: RoofingLine[] = [
  ...
  },
  {
    ...
    colors: [
      ...
      { id: 'std-cobblestone-gray', name: 'Cobblestone Gray', hex: '#A5A6A3', hue: 'Light neutral gray'       },
      { id: 'std-colonial-slate',  name: 'Colonial Slate',   hex: '#5B646D', hue: 'Deep blue-slate gray'      },
      { id: 'std-georgetown-gray', name: 'Georgetown Gray',  hex: '#7A7D81', hue: 'Medium cool gray'          },
      { id: 'std-driftwood',       name: 'Driftwood',        hex: '#7E6B5D', hue: 'Deep greyish brown'        },
      { id: 'std-burnt-sienna',    name: 'Burnt Sienna',     hex: '#7C5441', hue: 'Warm reddish brown'        },
      { id: 'std-resawn-shake',    name: 'Resawn Shake',     hex: '#96806C', hue: 'Natural weathered cedar'   },
      { id: 'std-heather-blend',   name: 'Heather Blend',    hex: '#88725C', hue: 'Muted brown-gray blend'    },
  ...
  },
  {
    ...
    colors: [
      ...
      { id: 'pro-charcoal',        name: 'Max Def Charcoal',         hex: '#363638', hue: 'High-definition charcoal'        },
      ...
      { id: 'pro-cobblestone-gray', name: 'Max Def Cobblestone Gray', hex: '#9C9C98', hue: 'High-definition light neutral gray' },
      { id: 'pro-colonial-slate',  name: 'Max Def Colonial Slate',   hex: '#525A63', hue: 'High-definition deep blue-slate' },
      { id: 'pro-georgetown-gray', name: 'Max Def Georgetown Gray',  hex: '#707377', hue: 'High-definition medium gray'     },
      { id: 'pro-driftwood',       name: 'Max Def Driftwood',        hex: '#746153', hue: 'High-definition warm brown'      },
      { id: 'pro-burnt-sienna',    name: 'Max Def Burnt Sienna',     hex: '#724937', hue: 'High-definition warm reddish-tan' },
      { id: 'pro-resawn-shake',    name: 'Max Def Resawn Shake',     hex: '#8C7561', hue: 'High-definition golden cedar shake' },
      { id: 'pro-heather-blend',   name: 'Max Def Heather Blend',    hex: '#7E6751', hue: 'High-definition deep brown-gray blend' },
