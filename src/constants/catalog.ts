...
export const ROOFING_OPTIONS: RoofingLine[] = [
  ...
  },
  {
    ...
    colors: [
      { id: 'pro-moire-black',     name: 'Max Def Moire Black',      hex: '#262628', hue: 'Ultra-HD deep black', swatchImage: '/textures/roofing/moire-black.jpg' },
      ...
      { id: 'pro-weathered-wood',  name: 'Max Def Weathered Wood',   hex: '#837461', hue: 'High-definition aged wood brown', swatchImage: '/textures/roofing/weathered-wood.jpg' },
      { id: 'pro-pewterwood',      name: 'Max Def Pewterwood',       hex: '#727475', hue: 'High-definition pewter gray-brown', swatchImage: '/textures/roofing/pewterwood.jpg' },
      ...
      { id: 'pro-driftwood',       name: 'Max Def Driftwood',        hex: '#746153', hue: 'High-definition warm brown', swatchImage: '/textures/roofing/driftwood.jpg' },
      ...
      { id: 'pro-resawn-shake',    name: 'Max Def Resawn Shake',     hex: '#8C7561', hue: 'High-definition golden cedar shake', swatchImage: '/textures/roofing/resawn-shake.jpg' },
