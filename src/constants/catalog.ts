...
export const ROOFING_OPTIONS: RoofingLine[] = [
  ...
  },
  {
    ...
    colors: [
      { id: 'std-moire-black',     name: 'Moire Black',      hex: '#2B2B2C', hue: 'Deep charcoal black', swatchImage: '/textures/roofing/moire-black.jpg' },
      ...
      { id: 'std-weathered-wood',  name: 'Weathered Wood',   hex: '#8B7E6D', hue: 'Aged wood gray-brown', swatchImage: '/textures/roofing/weathered-wood.jpg' },
      { id: 'std-pewter-gray',     name: 'Pewterwood',       hex: '#7B7D7E', hue: 'Medium gray with brown undertones', swatchImage: '/textures/roofing/pewterwood.jpg' },
      ...
      { id: 'std-driftwood',       name: 'Driftwood',        hex: '#7E6B5D', hue: 'Deep greyish brown', swatchImage: '/textures/roofing/driftwood.jpg' },
      ...
      { id: 'std-resawn-shake',    name: 'Resawn Shake',     hex: '#96806C', hue: 'Natural weathered cedar', swatchImage: '/textures/roofing/resawn-shake.jpg' },
      ...
      { id: 'std-silver-birch',    name: 'Silver Birch',     hex: '#CFD1D0', hue: 'Light reflective silver-white', swatchImage: '/textures/roofing/silver-birch.jpg' },
      { id: 'std-hunter-green',    name: 'Hunter Green',     hex: '#2D4F37', hue: 'Deep traditional forest green', swatchImage: '/textures/roofing/hunter-green.jpg' },
    ]
  },
  {
    tier: 'Landmark Pro',
    ...
    colors: [
      { id: 'pro-moire-black',     name: 'Max Def Moire Black',      hex: '#262628', hue: 'Ultra-HD deep black', swatchImage: '/textures/roofing/pro-moire-black.jpg' },
      { id: 'pro-charcoal',        name: 'Max Def Charcoal Black', hex: '#363638', hue: 'High-definition charcoal black', swatchImage: '/textures/roofing/pro-charcoal-black.jpg' },
      { id: 'pro-weathered-wood',  name: 'Max Def Weathered Wood',   hex: '#837461', hue: 'High-definition aged wood brown', swatchImage: '/textures/roofing/pro-weathered-wood.jpg' },
      { id: 'pro-pewterwood',      name: 'Max Def Pewterwood',       hex: '#727475', hue: 'High-definition pewter gray-brown', swatchImage: '/textures/roofing/pro-pewterwood.jpg' },
      { id: 'pro-cobblestone-gray', name: 'Max Def Cobblestone Gray', hex: '#9C9C98', hue: 'High-definition light neutral gray', swatchImage: '/textures/roofing/pro-cobblestone-gray.jpg' },
      { id: 'pro-colonial-slate',  name: 'Max Def Colonial Slate',   hex: '#66686A', hue: 'High-definition slate gray-blue', swatchImage: '/textures/roofing/pro-colonial-slate.jpg' },
      { id: 'pro-georgetown-gray', name: 'Max Def Georgetown Gray',  hex: '#707377', hue: 'High-definition medium gray', swatchImage: '/textures/roofing/pro-georgetown-gray.jpg' },
      { id: 'pro-driftwood',       name: 'Max Def Driftwood',        hex: '#746153', hue: 'High-definition warm brown', swatchImage: '/textures/roofing/pro-driftwood.jpg' },
      { id: 'pro-burnt-sienna',    name: 'Max Def Burnt Sienna',   hex: '#724937', hue: 'High-definition warm reddish-tan', swatchImage: '/textures/roofing/pro-burnt-sienna.jpg' },
      { id: 'pro-black-walnut',    name: 'Max Def Black Walnut',   hex: '#42332A', hue: 'High-definition walnut brown', swatchImage: '/textures/roofing/pro-black-walnut.jpg' },
      { id: 'pro-cinder-black',    name: 'Max Def Cinder Black',   hex: '#262628', hue: 'High-definition cinder black', swatchImage: '/textures/roofing/pro-cinder-black.jpg' },
      { id: 'pro-resawn-shake',    name: 'Max Def Resawn Shake',     hex: '#8C7561', hue: 'High-definition golden cedar shake', swatchImage: '/textures/roofing/pro-resawn-shake.jpg' },
      { id: 'pro-heather-blend',   name: 'Max Def Heather Blend',    hex: '#7E6751', hue: 'High-definition deep brown-gray blend', swatchImage: '/textures/roofing/pro-heather-blend.jpg' },
      { id: 'pro-mojave-tan',      name: 'Max Def Mojave Tan',       hex: '#836A51', hue: 'High-definition warm tan blend', swatchImage: '/textures/roofing/pro-mojave-tan.jpg' },
      { id: 'pro-shenandoah',      name: 'Max Def Shenandoah',       hex: '#4B5A50', hue: 'High-definition earthy gray-green blend', swatchImage: '/textures/roofing/pro-shenandoah.jpg' },
    ]
  },
];
